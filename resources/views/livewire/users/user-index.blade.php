            ...
            @foreach ($users as $user)
              <tr wire:key="user-{{ $user->id }}" class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <span
                    class="{{ $user->role === \App\Enums\UserRole::Admin ? "bg-indigo-100 text-indigo-700" : "bg-gray-100 text-gray-700" }} inline-flex rounded-full px-2.5 py-0.5 text-xs font-medium"
                  >
